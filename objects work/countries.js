var countries=[
  ...
  for (let country of countries){
      ...
      let obj={countryName,population,currencyName,capital}
...
// let chinaCur=mycountries.find(data=>data.countryName=="China").currencyName
// console.log(chinaCur);

// let pop=mycountries.forEach(data=>data.population>20000000?countryName);
// console.log(pop);
